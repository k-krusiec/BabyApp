    ...
    */
    ...
    $('.feedForm').submit(function(e) {
      e.preventDefault();
        ...
        //tymczas potrzebny do sortowania
        var sortDate = feedStartDate.split('-').join('') + feedStartTime.split(':').join('');
        ...
        if (feedStartDate.length != 0 && feedStartTime.length != 0) {
          objectStore.add({
            type: type,
    ...
    $('.weightForm').submit(function(e) {
      e.preventDefault();
        ...
        var sortDate = weightDate.split('-').join('') + '0000';
